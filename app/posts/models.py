...
class Post(db.Model):
    ...
    tags: so.Mapped[list["Tag"]] = so.relationship(secondary=post_tags, back_populates="posts", lazy='selectin')
...
class Tag(db.Model):
    ...
    posts: so.Mapped[list["Post"]] = so.relationship(secondary=post_tags, back_populates="tags", lazy='selectin')
